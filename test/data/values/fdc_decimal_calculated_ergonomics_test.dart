...
void main() {
  test('fdc decimal calculated ergonomics', () async {
    ...
    expect(
      FdcDataSetInternal.fieldValueAt(dataSet, 0, 'quarter'),
      '25.00'.decimal,
    );
    expect(
      FdcDataSetInternal.fieldValueAt(dataSet, 1, 'quarter'),
      '3.13'.decimal,
    );
    expect(
      FdcDataSetInternal.fieldValueAt(dataSet, 0, 'plus_fee'),
      '101.25'.decimal,
    );
